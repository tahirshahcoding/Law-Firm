...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), e.s(["config", 0, { matcher: ["/((?!api|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|json|webmanifest)).*)"] }, "default", 0, function(e10) {
        let { pathname: t10 } = e10.nextUrl;
        if (["/login", "/_next", "/favicon.ico", "/api/", "/home"].some((e11) => t10.startsWith(e11)) || "/" === t10) return es.next();
        if (!e10.cookies.get("access_token")?.value) {
          let t11 = new URL("/login", e10.url);
          return es.redirect(t11);
        }
        return es.next();
      }], 96592);
      let re = { ...e.i(96592) }, rt = "/middleware", rr = re.middleware || re.default;
      ...
      e.s(["default", 0, rn, "handler", 0, ri], 58217);
    }]);
  }
});
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|json|webmanifest)).*))(\\\\.json)?[\\/#\\?]?$"] }];
...
var BuildId = "pWCs9ahInD2k7Jo_QUIIH";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0kvehva.js", "server/edge/chunks/[root-of-the-server]__08ca2jv._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0lcpsxv.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0lcpsxv.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|json|webmanifest)).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|json|webmanifest)).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "pWCs9ahInD2k7Jo_QUIIH", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "WBFqsqOObBM5JOQVqNn6LkgH9YxtRoQOPoMMTdW5ivQ=", "__NEXT_PREVIEW_MODE_ID": "ebd612ff6045d041f7f016652761000c", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c72eea104ecd7f8b26e8b413fc49f316ca30390f9188ad9194a815366b604be8", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "561458ac53460f896fdd725cb2fa64804947ef24858ee6c75b1c7e3b1b74c4bf" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/(public)/home/page": "/home", "/(staff)/accounts/page": "/accounts", "/(staff)/audit-log/page": "/audit-log", "/(staff)/calendar/page": "/calendar", "/(staff)/cases/[id]/page": "/cases/[id]", "/(staff)/cases/page": "/cases", "/(staff)/cause-list/page": "/cause-list", "/(staff)/clients/page": "/clients", "/(staff)/consultations/page": "/consultations", "/(staff)/courts/page": "/courts", "/(staff)/daily-diary/page": "/daily-diary", "/(staff)/dashboard/page": "/dashboard", "/(staff)/deadlines/page": "/deadlines", "/(staff)/diary/page": "/diary", "/(staff)/expenses/page": "/expenses", "/(staff)/hearings/page": "/hearings", "/(staff)/invoices/page": "/invoices", "/(staff)/judges/page": "/judges", "/(staff)/login/page": "/login", "/(staff)/messages/page": "/messages", "/(staff)/reports/page": "/reports", "/(staff)/revenue/page": "/revenue", "/(staff)/settings/appearance/page": "/settings/appearance", "/(staff)/settings/backups/page": "/settings/backups", "/(staff)/settings/page": "/settings", "/(staff)/settings/permissions/page": "/settings/permissions", "/(staff)/settings/profile/page": "/settings/profile", "/(staff)/settings/security/page": "/settings/security", "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/api-proxy/[...path]/route": "/api-proxy/[...path]", "/apple-icon.png/route": "/apple-icon.png", "/favicon.ico/route": "/favicon.ico", "/icon.png/route": "/icon.png", "/manifest.webmanifest/route": "/manifest.webmanifest", "/page": "/" };
