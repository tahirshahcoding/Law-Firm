              ...
              <div className="p-4 border-t border-slate-100 bg-white shrink-0">
                <form onSubmit={handlePostNote} className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-24 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                  />
                  <button
                    type="submit"
