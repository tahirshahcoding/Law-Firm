...
export default function DashboardClientContent({ initialStats }: DashboardClientContentProps) {
  const { stats: fetchedStats, isLoading: loading } = useDashboard({ enabled: true, initialStats });
