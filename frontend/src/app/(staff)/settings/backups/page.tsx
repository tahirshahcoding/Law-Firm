  ...
  if (user?.role !== 'Admin') {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-800">Admin Only Feature</h2>
        <p className="text-slate-500 mt-2">You do not have permission to access system backups.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 w-full">
      <div>
        ...
        <p className="text-slate-500 mt-1">Download database snapshots and restore the system from backup files.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-slate-100 overflow-hidden">
        ...
        <div className="p-8">
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div>
              <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Last Backup</p>
              <p className="text-lg font-bold text-slate-900">
                {data?.last_backup ? formatDate(data.last_backup.created_at) : 'Never'}
              </p>
            </div>
            <div>
              <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Status</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-white border border-slate-200 text-slate-700 font-medium rounded-xl hover:bg-slate-50 transition-all shadow-sm flex items-center gap-2"
            >
              <Upload size={18} />
              Restore Backup
            </button>
            ...
            <div className="p-6">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 mb-6">
                <p className="text-sm font-medium text-slate-700 break-all">
                  File to restore: <span className="font-bold text-slate-900">{selectedFile?.name}</span>
                </p>
              </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow"
