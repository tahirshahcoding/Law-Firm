...
export function MonthlyRevenueChart({ trendData = [] }: { trendData?: { month: string, amount: number }[] }) {
...
export function CaseStatusChart({ active = 0, closed = 0, pending = 0 }: { active?: number, closed?: number, pending?: number }) {
