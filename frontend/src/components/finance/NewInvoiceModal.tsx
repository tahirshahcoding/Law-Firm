        ...
        <div className="overflow-y-auto flex-1">
          <form id="new-invoice-form" onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
            ...
            <div className="relative">
              <label className="block text-xs font-semibold text-slate-600 mb-1.5">Case*</label>
              {selectedCase ? (
                <div className="flex items-center justify-between px-3 py-2.5 border border-blue-300 rounded-xl bg-blue-50">
                  <div>
                    <p className="text-sm font-semibold text-slate-800">{selectedCase.case_number}</p>
                    <p className="text-xs text-slate-500">{selectedCase.client_name}</p>
                  </div>
                ...
                <div className="relative">
                  ...
                  />
                  {showCaseDropdown && (
                    <div className="absolute z-10 w-full top-full mt-1 bg-white border border-slate-200 rounded-xl shadow-lg max-h-48 overflow-y-auto">
                      {loadingCases ? (
